...
for funcLevel1,funcLevel2 in funcList:
    ...
    for i, csv in enumerate(csv_files):
        ...
        #For prediction, delete index_col!!!
...
###
'''
GeneralMedian.insert(loc=0, column='id', value=targetLabel)

#ResultDataFrame.to_csv("EnsembleResult.csv", index=None)
GeneralMedian.to_csv("EnsembleResultGeneralMedian.csv", index=None)
GeneralMean.to_csv("EnsembleResultGeneralMean.csv", index=None)
